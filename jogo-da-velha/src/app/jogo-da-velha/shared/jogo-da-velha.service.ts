...
export class JogoDaVelhaService {
  ...
  private readonly DIMENSAO_TABULEIRO: number = 3;
  ...
  inicializarTabuleiro(): void {
    this.tabuleiro = [this.DIMENSAO_TABULEIRO];
  ...
  obterJogada(jogador: number): number[] {
    ...
    for (let lin = 0; lin < this.DIMENSAO_TABULEIRO; lin++ ) {
      for (let col = 0; col < this.DIMENSAO_TABULEIRO; col++ ) {
